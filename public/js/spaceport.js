...
var _index = require('./../lists/index.vue');

var _index2 = _interopRequireDefault(_index);

var _create = require('./../lists/create.vue');

var _create2 = _interopRequireDefault(_create);

var _edit = require('./../lists/edit.vue');
...
Vue.component('spaceport-list-index', _index2.default);

Vue.component('spaceport-list-create-form', _create2.default);

Vue.component('spaceport-list-edit-form', _edit2.default);

//require('./../forms/bootstrap.js')

},{"./../lists/create.vue":5,"./../lists/edit.vue":6,"./../lists/index.vue":7,"./../myforms/bootstrap.js":8}],5:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    watch: {
        'list': function list(_list) {
            this.forms.editList.name = _list;
        }
    },
    ...
    methods: {
        getList: function getList(id) {
            this.$http.get('/api/lists/' + id).then(function (list) {
                this.list = list.data;
        ...
        saveList: function saveList() {
            ...
            Spark.put('/api/lists/' + this.list.id, this.forms.editList).then(function () {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"panel-heading\">Listes</div>\n<form role=\"form\">\n    <div class=\"panel-body\">\n        <form-text :display=\"'Name'\" :form=\"forms.editList\" :name=\"'name'\" :input.sync=\"forms.editList.name\">\n        </form-text>\n    </div>\n    {{ forms.editList.name }} looks good! <br>\n    {{ list }}\n    <div class=\"panel-footer\">\n        <button v-on:click=\"saveList\" class=\"btn btn-primary\">Save</button>\n    </div>\n</form>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\psamson\\Documents\\GitHub\\spaceport\\resources\\assets\\js\\lists\\edit.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\psamson\\Documents\\GitHub\\spaceport\\resources\\assets\\js\\lists\\index.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
$.extend(Spaceport, require('./http'));

require('./components');

},{"./components":9,"./errors":10,"./http":12,"./instance":13}],9:[function(require,module,exports){
'use strict';

var _textField = require('./fields/text-field.vue');

var _textField2 = _interopRequireDefault(_textField);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

Vue.component('text-field', _textField2.default);

},{"./fields/text-field.vue":11}],10:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\psamson\\Documents\\GitHub\\spaceport\\resources\\assets\\js\\myforms\\fields\\text-field.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
